...
import { headerPortfolioImg } from '../projects/assets'
...
const ProjectHeroCard = ({name, img,place, description, date, link}) => {
    return (
            ...
            <Link href={link} className='relative flex '>
                <div className="relative transition duration-700 ease-in-out hover:translate-x-3 hover:translate-y-3">
                    <div className='absolute md:bottom-[7vh] z-10 text-white m-7'>
                        <h1 className={`${poppins.variable} font-Poppins text-xl md:text-3xl font-semibold my-3`}>{name}</h1>
                        <h2 className={`${poppins.variable} font-Poppins md:text-lg my-3`}>{description}</h2>
                        <div>
                            <div className={`${poppins.variable} font-Poppins text-sm md:text-base mt-7 pl-[17px] font-semibold`}>
                                {date}
                            </div>
                            <h2 className={`${poppins.variable} text-white font-Poppins flex items-center text-sm md:text-base font-semibold`}>
                    ...
                    <Image className='max-w-[55vw]  w-[50rem] rounded-xl min-w-[23rem]' src={img} width={500} height={500} alt='head' />
