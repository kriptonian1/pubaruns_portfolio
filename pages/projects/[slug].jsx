        ...
        <div>
            ...
            <div className='conatiner mx-auto bg-black mt-10 lg:mx-16 rounded-md relative'>
                ...
                <div className='absolute inset-0 text-center flex flex-col justify-center items-center gap-0'>
                    ...
                    <p className='lg:text-xl italic text-white font-Poppins m-[17px] font-light'>A photo Series by <span className='not-italic lg:text-4xl text-2xl pl-2 text-white'>Pubarun Basu</span></p>
                ...
                <div className='absolute bottom-1 p-10  w-full'>
                    <div className='flex flex-row justify-between gap-10'>
                        ...
                        <div className='flex flex-row justify-center items-center'>
                            ...
                            <a href={source.location_link} target="_blank" rel='noreferrer' className='ml-1 text-white font-Poppins underline hover:underline-offset-4 underline-offset-2 cursor-pointer'>{source.location_Name}
                            </a>
                        </div>
                    </div>
                </div>
