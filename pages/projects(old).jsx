...
const projects = () => {
  ...
  const data = [
    ...
    },
    {
      ...
      date: "7th Aug, 2022",
      description: "n the state of Maharashtra in India, an 800 years old tradition still finds its way in the modern world. In the month of Asadh, the agrarian  ....",
      image: projectThumb2
    },{
      title: "Shekhawati - The Cradle of Life",
      date: "7th Aug, 2022",
      description: "The history of Shekhawati is composed of ancient myths and fables that shape the modern-day narrative of its culture. What once used to be....",
      image: projectThumb3
    },
  ]
